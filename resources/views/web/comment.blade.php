...
@section('content')
    ...
    <!-- Service Start -->
    <div class="container-fluid pt-5" id="comment-card">
        <div class="container">
            <div class="row">
                ...
                <div class="card mt-50 mb-50">
                    ...
                    <a class="btn btn-primary btn-sm" href="#" style="margin-top:-1px" onclick="showForm()">
                        <i class="fas fa-comment"></i> @if (count($comments) == 0) Buat Comentar @else Balas @endif
                    </a>
                    <form action="{{ route('comment.store', ['orderId' => $order_id]) }}" id="formComment" method="POST" enctype="multipart/form-data" style="margin-top: 20px;display:none">
                        @csrf
                        <span id="card-header">Masukkan Complain:</span>
                        <div class="row-1">
                            <div class="row row-2">
                                <textarea class="form-control" name="text" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <button class="btn d-flex mx-auto"><b>Kirim</b></button>
                    </form>
                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function showForm() {
            var x = document.getElementById("formComment");
